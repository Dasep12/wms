...
<script>
    $(document).ready(function() {
        ...
        function actionBarangFormatter(cellvalue, options, rowObject) {
            ...
            var btn = `<button data-id="${btnid}" onclick="CrudPackaging('update','${btnid}')"  class="btn btn-sm text-white btn-option badge-success"><i class="fa fa-pencil"></i></button>`;
            btn += `<a  data-id="${btnid}" onclick="CrudPackaging('delete','${btnid}')" class="btn btn-sm text-white btn-option badge-danger"><i class="fa fa-remove"></i></a>`;
            return btn;
        }
